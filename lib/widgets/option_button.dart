...
enum OptionState {
  ...
  /// Chosen, but neither confirmed right nor wrong yet -- used by screens
  /// (Take a Test) that register a choice without revealing correctness
  /// until later, so the option reads as "picked" without colour-coding.
  selectedNeutral,
}
  ...
  Widget build(BuildContext context) {
    ...
    switch (state) {
      ...
      case OptionState.revealCorrect:
        ...
        selected = true;
        break;
      case OptionState.selectedNeutral:
